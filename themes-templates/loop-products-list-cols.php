...
$title_tag			= isset( $instance['title_tag'] ) ? $instance['title_tag'] : 'span';
if ( have_posts() ) :
	$end_of_row = true;
	?>
...
<?php while ( have_posts() ) : the_post();
	...
	<?php if ( $instance['see_title'] ) : ?>
		<h3 class="entry-title"><a href="<?php the_permalink();?>" border="0"><?php the_title(); ?></a></h3>
	<?php endif;?>

	<?php if ( $instance['see_image'] ) : ?>
		<div class="entry-image">
			<a href="<?php echo the_permalink();?>" border="0"><?php the_post_thumbnail( $instance['image_size'] , array( 'alt' => get_the_title(), 'title' => get_the_title() ) ); ?></a>
		</div><!-- entry-image -->
	<?php endif;?>

	<?php if ( $instance['see_price'] ) :?>
		<div class="entry-product_custom">
			<p class="entry_tcp_price"><?php echo __( 'price', 'tcp' );?>:&nbsp;<?php tcp_the_price_label();?>&nbsp;<?php tcp_the_currency();?>(<?php tcp_the_tax_label();?>)</p>
		<div>
	<?php endif;?>
