...
//		add_settings_field( 'use_default_loop', __( 'Use TCP template', 'tcp' ), array( $this, 'show_use_default_loop' ), __FILE__ , 'tcp_theme_compatibility_section' );
//		add_settings_field( 'use_tcp_loop', __( 'Use TCP Loop', 'tcp' ), array( $this, 'show_use_tcp_loop' ), __FILE__ , 'tcp_theme_compatibility_section' );

		add_settings_field( 'use_default_loop', __( 'Theme templates', 'tcp' ), array( $this, 'show_use_default_loop' ), __FILE__ , 'tcp_theme_compatibility_section' );	
...
<?php global $thecartpress;
	$use_default_loop = isset( $thecartpress->settings['use_default_loop'] ) ? $thecartpress->settings['use_default_loop'] : 'none';
	...
	function show_use_default_loop( $use_default_loop = false ) {
		if ( ! $use_default_loop ) {
			global $thecartpress;
			$use_default_loop = isset( $thecartpress->settings['use_default_loop'] ) ? $thecartpress->settings['use_default_loop'] : 'only_settings';
		} ?>
