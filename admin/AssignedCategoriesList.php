...
$post_id = isset( $_REQUEST['post_id'] ) ? tcp_input_number( $_REQUEST['post_id'] ) : 0;
if ( $post_id == 0 ) {
	die( __( 'post_id param required!!!', 'tcp' ) );
}
$rel_type = isset( $_REQUEST['rel_type'] ) ? sanitize_text_field( $_REQUEST['rel_type'] ) : 'PROD-CAT_POST';
