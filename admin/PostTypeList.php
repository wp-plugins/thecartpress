...
<ul class="subsubsub">
	<li><a href="<?php echo TCP_ADMIN_PATH; ?>PostTypeEdit.php"><?php _e( 'create new post type', 'tcp' ); ?></a></li>
</ul>
<div class="clear"></div>
...
<tr>
	...
	<td><a href="<?php echo TCP_ADMIN_PATH; ?>PostTypeEdit.php&posttype_id=<?php echo $posttype_id; ?>"><?php _e( 'edit', 'tcp' ); ?></a>
